...
This week helped me understand what switches actually do in a network. Before this, I knew that switches connected devices, but now I understand that switches learn MAC addresses and use that information to forward traffic efficiently. I also understand why ARP is important and how it helps devices communicate on a local network.
